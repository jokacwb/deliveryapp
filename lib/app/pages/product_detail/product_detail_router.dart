...
class ProductDetailRouter {
  ...
  static const String constOrderProductDto = 'orderProductDto';
  static const String constProduct = 'product';
  ...
  static Widget get page => MultiProvider(
        ...
        builder: (context, child) {
          ...
          return ProductDetailPage(
            product: args[constProduct],
            orderProdutoDto: args[ProductDetailRouter.constOrderProductDto],
          );
        },
      );
}
